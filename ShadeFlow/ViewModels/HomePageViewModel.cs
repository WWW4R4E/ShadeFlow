...
namespace ShadeFlow.ViewModels
{
	public partial class HomePageViewModel : ObservableObject
	{
		...
		public async Task InitializeRendererAsync(int width, int height, double dpiScale)
		{
			...
			try
			{
				...
				// 添加默认渲染对象
				string vertexShaderPath = "C:\\Users\\123\\Desktop\\Zig_Note\\dx11_zig\\zig-out\\shaders\\TriangleVS.cso";
				string pixelShaderPath = "C:\\Users\\123\\Desktop\\Zig_Note\\dx11_zig\\zig-out\\shaders\\TrianglePS.cso";
