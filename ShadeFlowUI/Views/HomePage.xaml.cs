...
namespace ShadeFlow.Views
{
    public sealed partial class HomePage : Page
    {
        ...
        public static readonly DependencyProperty SelectedFolderPathProperty =
            DependencyProperty.Register(nameof(SelectedFolderPath), typeof(string), typeof(HomePage),
                new PropertyMetadata(null, (sender, e) =>
                {
                    if (sender is HomePage page && e.NewValue is string path)
                    {
                        page.explorerControl.LoadFolder(path);
                    }
                }));
        ...
        private void UpdateHoverZones()
        {
            ...
            VerticalHoverZone1.Margin = new Thickness(vertical1X, vertical1Y + 48, 0, 0);
